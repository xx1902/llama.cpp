...
static kv_delta_probe_result run_kv_delta_probe_pair(
    ...
    if (self_before_copy.probe_status != "ok" ||
            ...
            self_before_copy.kv_l2_avg > 1e-4) {
...

    {
        ...
        probe_results.push_back(
                run_kv_delta_probe_pair(
                        ...
                        vocab,
                        "animal_semantic",
                        "tiger_cn_vs_tiger_en",
                        "Please introduce the characteristics of tiger.",
                        "Please describe the features of tiger.",
                        4,
                        5));

        // 自己对比，检查一下代码本身问题
        // 1.检查 kv_delta_probe 代码
        probe_results.push_back(
                run_kv_delta_probe_pair(
                        ctx,
                        vocab,
        ...
        // 3.单独看 LoRA 对 KV 的影响。
        // probe_results.push_back(
        //         run_kv_delta_probe_pair_with_lora(
        //                 ctx,
        //                 vocab,
        //                 "same_prompt_diff_lora",
        //                 "same_prompt_monkey_lora_vs_tiger_lora",
        //                 "You are an animal introduction expert. Please introduce the characteristics of tiger.",
        //                 "You are an animal introduction expert. Please introduce the characteristics of tiger.",
        //                 0,
        //                 1,
